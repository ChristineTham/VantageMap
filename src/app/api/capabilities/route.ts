/**
 * Step 5.1 — Business Capability API (collection)
 *
 * GET  /api/capabilities — List with pagination, sorting, filtering
 * POST /api/capabilities — Create a new business capability
 */
...
const config: CrudConfig<typeof businessCapabilities> = {
